...
namespace TradingConsole.Wpf.ViewModels
{
    public class AnalysisResult : ObservableModel
    {
        ...
        private int _participationScore;
        public int ParticipationScore { get => _participationScore; set => SetProperty(ref _participationScore, value); }

        private decimal _skewRatio;
        public decimal SkewRatio { get => _skewRatio; set => SetProperty(ref _skewRatio, value); }
